namespace Microsoft.Practices.EnterpriseLibrary.Security.Cryptography.Configuration.Design
{
    partial class CryptographicKeyWizard
    {
        ...
        private void InitializeComponent()
        {
			...
			this.chooseProtectionScopeControl = new Microsoft.Practices.EnterpriseLibrary.Security.Cryptography.Configuration.Design.ChooseKeyFileControl();
			this.createNewKeyControl = new Microsoft.Practices.EnterpriseLibrary.Security.Cryptography.Configuration.Design.CreateNewKeyControl();
			this.chooseDpapiScopeControl = new Microsoft.Practices.EnterpriseLibrary.Security.Cryptography.Configuration.Design.ChooseDataProtectionScopeControl();
			this.importArchivedKeyControl = new Microsoft.Practices.EnterpriseLibrary.Security.Cryptography.Configuration.Design.ImportArchivedKeyControl();
			this.supplyKeyControl = new Microsoft.Practices.EnterpriseLibrary.Security.Cryptography.Configuration.Design.SupplyKeyControl();
			this.openExistingKeyFileControl = new Microsoft.Practices.EnterpriseLibrary.Security.Cryptography.Configuration.Design.OpenExistingKeyFileControl();
